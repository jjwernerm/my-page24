                    ...
                    <div className="ml-10 flex items-baseline space-x-4 text-white font-medium">
                      {navigationArray.map((item) => (
                        <NavLink
                          key={item.name}
                          to={item.href}
                          className={({ isActive }) => isActive ? "bg-gray-900 rounded-md p-2" : "hover:bg-gray-700 rounded-md p-2"}
                        >
                          {item.icon}
                          {' '}
                          {item.name}
              ...
              <div className="space-y-1 px-2 pb-3 pt-2 sm:px-3 text-white font-medium">
                {navigationArray.map((item) => (
                  <NavLink
                    key={item.name}
                    to={item.href}
                    className={({ isActive }) => isActive ? "bg-gray-900 rounded-md block p-2" : "hover:text-gray-300 hover:bg-gray-700 rounded-md block p-2"}
                    onClick={close}
                  >
                    {item.icon}
                    {' '}
